...
function App() {
  ...
  const [outputText, setOutputText] = useState(""); // New text box state
        ...
        <div className="options-container">
          ...
          {(selectedOption === "Generate Code" || selectedOption === "Modify Code") && (
            <div className="content-wrapper">
              ...
              <div className="input-section shifted-left">
              ...
              {/* Right Side: Large Text Box */}
              <div className="output-section">
                <textarea
                  className="large-textbox aligned-right"
